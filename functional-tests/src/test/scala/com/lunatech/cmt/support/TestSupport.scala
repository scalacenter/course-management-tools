...
def studentifyMainRepo(tmpDir: File, repoName: String, mainRepo: File): File =
  import com.lunatech.cmt.admin.Domain.{ForceDeleteDestinationDirectory, InitializeGitRepo, StudentifyBaseDirectory}
  import com.lunatech.cmt.admin.command.Studentify
